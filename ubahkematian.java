...
public class ubahkematian extends javax.swing.JFrame {
    ...
    private DefaultTableModel tablekematian;
    private DefaultTableModel model;
    String vnama_lengkap, vjk, valamat,vtgl_kelahiran,vtgl_kematian,vhari_kematian,vumur,vtmp_kematian,vsebab_kematian,vpekerjaan, vkewarganegaraan,vagama,vsatus_perkawinan,vno_kk,vno_ktp,vnama_pelapor,vhub_pelapor,vpetugas;
    ...
    public ubahkematian() {
        initComponents();
         try{
                ...
                sqlupdate = "update kematian set  ";
                Statement stat = _Cnn.createStatement();
                stat.executeQuery(sqlupdate);
     ...
     private void ambildata(){
        ...
        combostatus.setSelectedItem(vsatus_perkawinan);
    ...
    /* private void aksiubah() {
        ...
        if(btnubah.getText().equals("UBAH")){
            sqlupdate = "update kematian set no_ktp ='"+vno_ktp+"',nama_lengkap ='"+vnama_lengkap+"',jk='"+vjk+"',alamat='"+valamat+"',"
                    + "tanggal_kelahiran='"+vtanggalkelahiran+"',tanggal_kematian='"+vtanggalkematian+"',hari_kematian='"+vhari_kematian+"',"
                    + "umur ='"+vumur+"',tempat_kematian ='"+vtmp_kematian+"', sebab_kematian ='"+vsebab_kematian+"',pekerjaan ='"+vpekerjaan+"',kewarganegaraan ='"+vkewarganegaraan+"',agama='"+vagama+"',status_perkawinan='"+vsatus_perkawinan+"',no_kk='"+vno_kk+"', "
                    + "nama_pelapor='"+vnama_pelapor+"',hubungan_pelapor='"+vhub_pelapor+"',petugas='"+vpetugas+"'"; 
        }
        try{
            _Cnn = getCnn.getConnection ();
            Statement stat = _Cnn.createStatement();
    ...
    private void datetglkelahiranPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_datetglkelahiranPropertyChange
        /*try{
            if(datetglkelahiran.getDate()!= null){
                ...
                vtgl_kelahiran=String.valueOf(format.format(datetglkelahiran.()));
...
//aksisimpan();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ubahkematian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
